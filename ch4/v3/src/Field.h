...
// };
template <class data_type>
Field<data_type>::Field(int ni, int nj, int nk): ni{ni}, nj{nj}, nk{nk}, nn{ni, nj, nk}, m_size{ni*nj*nk} {
    this->data = std::vector<std::vector<std::vector<data_type>>>(ni, std::vector<std::vector<data_type>>(nj, std::vector<data_type>(nk)));
};
template <class data_type>
Field<data_type>::Field(int nn[3]): ni{nn[0]}, nj{nn[1]}, nk{nn[2]}, nn{ni, nj, nk}, m_size{ni*nj*nk}{
    this->data = std::vector<std::vector<std::vector<data_type>>>(ni, std::vector<std::vector<data_type>>(nj, std::vector<data_type>(nk)));
};
template <class data_type>
Field<data_type>::Field(int3 nn): ni{nn[0]}, nj{nn[1]}, nk{nn[2]}, nn{ni, nj, nk}, m_size{ni*nj*nk}{
    this->data = std::vector<std::vector<std::vector<data_type>>>(ni, std::vector<std::vector<data_type>>(nj, std::vector<data_type>(nk)));
};
template <class data_type>
Field<data_type>::Field(const Field<data_type>& other): ni{other.ni}, nj{other.nj}, nk{other.nk}, nn{other.ni, other.nj, other.nk}, m_size{other.m_size} {
    //std::cout << "copied\n";
    this->data = std::vector<std::vector<std::vector<data_type>>>(ni, std::vector<std::vector<data_type>>(nj, std::vector<data_type>(nk)));
...
template <class data_type>
Field<data_type>::Field(Field<data_type>&& other): ni{other.ni}, nj{other.nj}, nk{other.nk}, nn{other.ni, other.nj, other.nk}, m_size{other.m_size} {
    //std::cout << "moved\n";
...
template <class data_type>
int Field<data_type>::size() const{
    return m_size;
}
