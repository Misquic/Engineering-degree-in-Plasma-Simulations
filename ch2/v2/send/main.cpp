...
///////////////////////////////////////
        ...
        // species[0].advance();
        // species[1].advance();
        // //Output::fields(*world_ptr, species, "advance");

        // species[0].computeNumberDensity();
        // species[1].computeNumberDensity();
        // //Output::fields(*world_ptr, species, "numdens");

        world_ptr->computeChargeDensity(species);
        //Output::fields(*world_ptr, species, "chargedens");

        solver_ptr->solveGS();
        //Output::fields(*world_ptr, species, "GS");

        solver_ptr->computeEF();
        //Output::fields(*world_ptr, species, "EF");
