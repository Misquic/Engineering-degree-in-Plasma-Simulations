...
/*constructors*/
World::World(int ni, int nj, int nk): ni{ni}, nj{nj}, nk{nk}, nn{ni, nj, nk}, phi(ni, nj, nk), rho(ni, nj, nk), node_vol(ni, nj, nk), ef(ni, nj, nk), time_start{std::chrono::high_resolution_clock::now()}{
};
World::World(int ni, int nj, int nk, type_calc x1, type_calc y1, type_calc z1, type_calc x2, type_calc y2, type_calc z2): ni{ni}, nj{nj}, nk{nk}, nn{ni, nj, nk}, phi(ni, nj, nk), rho(ni, nj, nk), node_vol(ni, nj, nk), ef(ni, nj, nk), time_start{std::chrono::high_resolution_clock::now()}{
    setExtents(x1, y1, z1, x2, y2, z2);
};
World::World(int ni, int nj, int nk, type_calc3 vec1, type_calc3 vec2): ni{ni}, nj{nj}, nk{nk}, nn{ni, nj, nk}, phi(ni, nj, nk), rho(ni, nj, nk), node_vol(ni, nj, nk), ef(ni, nj, nk), time_start{std::chrono::high_resolution_clock::now()}{
